...
# The function makeCachemetrix creates a special matrix object that can cache its inverse.
# It contains four functions set, get, setinverse, getinverse. Below comments are provided
# to expalin each of these functions.
